      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className={`text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-200 ${
            ...
            Get to know the passionate individuals driving innovation and entrepreneurship at E-Cell SMEC.
          </p>
        </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {members.map((member, memberIndex) => (
                  <div
                    key={memberIndex}
                    className="p-6 rounded-2xl bg-card/80 border border-primary/10 hover:border-primary/30 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/10 text-center"
                  >
                    <div className="mb-4">
                      <img 
                        src={member.image} 
                        alt={member.name}
                        className="w-24 h-24 object-cover rounded-full mx-auto border-4 border-primary/20"
                        onError={(e) => {
