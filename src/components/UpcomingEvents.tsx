  ...
  const events = [
    {
      ...
      activities: [
        "Week 1: Welcome Post – Introduce NEC E-Cell, vision & mission.",
    ...
    },
    {
      ...
      activities: [
        ...
        "Week 4: Vision Board Posts – What NEC E-Cell aims for this year."
      ]
    },
    {
      month: "FEBRUARY 2026",
    ...
    },
    {
      ...
      icon: <Calendar className="w-6 h-6" />,
      activities: [
        "Week 1: IIT/IIM E-Cell Collabs – Shoutouts, collab content.",
